...
const model = process.env.VOLCENGINE_ARK_SPEECH_MODEL || 'doubao-seed-2-0-pro-260215';
  ...
  input: [
    {
      role: 'user',
      content: [
        { type: 'input_text', text: '请将这段语音转写为文字，只输出转写结果，不要解释。' },
...
writeFileSync('scripts/test-ark-audio-response.json', text);
